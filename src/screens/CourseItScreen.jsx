...
const CourseItScreen = ({navigation}) => {
  ...
  return (
    <ScrollView>
      ...
      <View className="my-5">
        <TouchableOpacity onPress={() => navigation.navigate('ITStuCoursePDF')}>
          <LinearGradient
            start={{x: -1, y: 0}}
            end={{x: 1, y: 0}}
            colors={['#62cff4', '#2c67f2']}
      ...
      <View className="my-5">
        <TouchableOpacity onPress={() => navigation.navigate('ITOldCoursePDF')}>
          <LinearGradient
            start={{x: -1, y: 0}}
            end={{x: 1, y: 0}}
            colors={['#62cff4', '#2c67f2']}
      ...
      <View className="my-5">
        <TouchableOpacity onPress={() => navigation.navigate('IT62CoursePDF')}>
          <LinearGradient
            start={{x: -1, y: 0}}
            end={{x: 1, y: 0}}
            colors={['#62cff4', '#2c67f2']}
