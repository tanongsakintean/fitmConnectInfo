  ...
  return (
    <SafeAreaView>
      <ScrollView>
        ...
        <View className="bg-[#20A5DE] my-3 mt-6 p-4 shadow-md flex flex-row justify-center">
          <View>
        ...
        <View className="bg-[#20A5DE] my-5 mt-6 p-4 shadow-md flex flex-row justify-center">
          <View>
            <Text style={{fontFamily: 'Kanit-Bold'}} className=" text-white">
